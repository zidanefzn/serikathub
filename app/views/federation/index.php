            ...
            <div class="bg-light rounded h-100 p-4">
                <div class="row">
                        <div class="col-sm-12 d-flex justify-content-between">
                            <h2 class="mb-4">Daftar Federasi</h2>
                            <div>
                                <a href="<?= BASEURL; ?>/Federation/generatePdf" class="btn btn-secondary"><i class="fa-solid fa-file-pdf"></i> PDF</a>
                                <a href="<?= BASEURL; ?>/Federation/generateCsv" class="btn btn-secondary"><i class="fa-solid fa-file-csv"></i> CSV</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="example" class="table table-bordered table-striped text-center align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $fed['nama']; ?></td>
                                <td><?= $fed['alamat']; ?></td>
                                <td><?= $fed['no_pencatatan']; ?></td>
                                <td class="text-center"><?= $fed['total_anggota']; ?></td>
                                <td><a href="<?= BASEURL; ?>/FederationLeader/FederationLeader/<?= $fed['id']; ?>" class="btn btn-outline-secondary btn-sm">Detail</a></td>
                                <td><?= $fed['keterangan']; ?></td>
                                <td><a href="<?= BASEURL; ?>/Federation/editFederation/<?= $fed['id']; ?>" class="link-secondary showEditModal federation" data-bs-toggle="modal" data-bs-target="#formModal" data-id="<?= $fed['id'] ?>"><i class="fa-solid fa-pen-to-square fs-3"></i></a></td>
                                <td><a href="<?= BASEURL; ?>/Federation/deleteFederation/<?= $fed['id']; ?>" class="link-danger"><i class="fa-solid fa-trash fs-3"></i></a></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
                    ...
                    <div class="modal fade" id="formModal" tabindex="-1" aria-labelledby="modalTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            ...
                            <div class="modal-body">
                                <form action="<?= BASEURL; ?>/Federation/addFederation" method="post">
