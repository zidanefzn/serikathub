                    ...
                    <table id="example" class="table table-bordered table-striped text-center align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $confed['nama']; ?></td>
                                <td><?= $confed['alamat']; ?></td>
                                <td><?= $confed['no_pencatatan']; ?></td>
                                <td class="text-center"><?= $confed['total_anggota']; ?></td>
                                <td><a href="<?= BASEURL; ?>/ConfederationLeader/ConfederationLeader/<?= $confed['id']; ?>" class="btn btn-outline-secondary btn-sm">Detail</a></td>
                                <td><?= $confed['keterangan']; ?></td>
                                <td><a href="<?= BASEURL; ?>/Confederation/editConfederation/<?= $confed['id']; ?>" class="link-secondary showEditModal confederation" data-bs-toggle="modal" data-bs-target="#formModal" data-id="<?= $confed['id'] ?>"><i class="fa-solid fa-pen-to-square fs-3"></i></a></td>
                                <td><a href="<?= BASEURL; ?>/Confederation/deleteConfederation/<?= $confed['id']; ?>" class="link-danger"><i class="fa-solid fa-trash fs-3"></i></a></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
